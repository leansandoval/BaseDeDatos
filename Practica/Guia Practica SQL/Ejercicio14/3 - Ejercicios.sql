/*Ejercicio 14: Dado el siguiente esquema de relacion

	Festejo (NroFestejo, Descripcion, fecha, nrocliente)
	Contrata (NroFestejo, Item, NroServicio, HDesde, HHasta)
	Servicio (NroServicio, Descripcion, Precio)
...
fueron contratados en todos los festejos del periodo enviado por parametro. De dichos servicios mostrar el 
nombre y la cantidad de horas que fueron contratadas en el periodo enviado por parametro.
Ejemplificar la invocacion del procedimiento.*/
...
valor predeterminado 0 (cero). Este campo servira para que ya se encuentre precalculado la cantidad de minutos 
que fue contratado el servicio, sin necesidad de realizar el calculo con los campos de la tabla.*/
...
desde no puede ser posterior a la hora hasta, si esto sucede se debera avisar y volver atras la operacion. 
Ademas, tener en cuenta las actualizaciones masivas. Ejemplificar la invocacion del trigger.*/
...
/*Prueba si funciona correctamente el trigger*/
